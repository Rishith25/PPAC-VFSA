...
def main():
    parser = argparse.ArgumentParser(
        description="Decrypt a file and return content as base64."
    )
    parser.add_argument(
        "encrypted_file_name",
        type=str,
        help="Name of the encrypted file in ENCRYPT_DIR",
    )
    parser.add_argument(
        "aes_key",
        type=str,
    ...
    try:
        ...
        decrypted_bytes = decrypt_file(encrypted_file_path, aes_key)
